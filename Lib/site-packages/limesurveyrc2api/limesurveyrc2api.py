...
class _Respond(object):

    def __init__(self, lime_survey_api):
        self.api = lime_survey_api

    def list_res(self, session_key, survey_id,
                       document_type):
        """
        Return a list of questions from the specified survey.
...
class _Statistics(object):
    ...
    def list_stats(self, session_key, survey_id,
                       document_type):
        """
        Return a list of questions from the specified survey.
        ...
        data = self.api.utils.prepare_params('export_statistics', params)
        response = self.api.utils.request(data)
        return response    
